      ...
      function (require, module, exports) {
        ...
        (module.exports = i),
          ...
          (r.prototype.unpack_uint64 = function () {
            var t = this.read(8),
              e =
                256 * (256 * (256 * (256 * (256 * (256 * (256 * t[0] + t[1]) + t[2]) + t[3]) + t[4]) + t[5]) + t[6]) +
                t[7];
          ...
          (r.prototype.unpack_double = function () {
            var t = this.unpack_uint32(),
              ...
              i = ((t >> 20) & 2047) - 1023;
            return (
              (0 === t >> 31 ? 1 : -1) * (((1048575 & t) | 1048576) * Math.pow(2, i - 20) + e * Math.pow(2, i - 52))
            );
          }),
              ...
              ('function' == typeof i
                ? (e.navigator.mediaDevices.getDisplayMedia = function (a) {
                    return i(a).then(function (i) {
                      ...
                      return (
                        (a.video = {
                          mandatory: { chromeMediaSource: 'desktop', chromeMediaSourceId: i, maxFrameRate: d || 3 },
                        }),
      ...
      function (require, module, exports) {
                  ...
                  return (
                    e.result().forEach(function (e) {
                      var r = {
                        ...
                        type:
                          { localcandidate: 'local-candidate', remotecandidate: 'remote-candidate' }[e.type] || e.type,
                      };
        ...
        function l(t, r) {
          e.wrapPeerConnectionEvent(t, 'negotiationneeded', function (e) {
            var t = e.target;
            if (
              !(r.version < 72 || (t.getConfiguration && 'plan-b' === t.getConfiguration().sdpSemantics)) ||
      ...
      function (require, module, exports) {
        ...
        (r.localCName = r.generateIdentifier()),
          ...
          (r.parseCandidate = function (r) {
            for (
              var e,
                t = {
                  foundation: (e =
                    0 === r.indexOf('a=candidate:') ? r.substring(12).split(' ') : r.substring(10).split(' '))[0],
          ...
          (r.parseSsrcMedia = function (r) {
            ...
            return (
              a > -1
                ? ((t.attribute = r.substr(e + 1, a - e - 1)), (t.value = r.substr(a + 1)))
              ...
              n.codecs.forEach(function (r) {
                if ('RTX' === r.name.toUpperCase() && r.parameters.apt) {
                  ...
                  c && t && (e.rtx = { ssrc: t }),
                    a.push(e),
                    s &&
                      (((e = JSON.parse(JSON.stringify(e))).fec = { ssrc: c, mechanism: i ? 'red+ulpfec' : 'red' }),
                      a.push(e));
                }
              }),
                    ...
                    if (
                      ...
                      if ('answer' === t.type && !g) {
                        (P = (C = r.transceivers[o]).iceGatherer),
                          ...
                          (m && 0 !== o) ||
                            ('new' === w.state && w.start(P, I, 'controlling'), 'new' === R.state && R.start(L)),
          ...
          if (
            ...
            if (
              ...
              i.prototype.getSettings = function () {
                ...
                return (
                  a(e, 'mozAutoGainControl', 'autoGainControl'), a(e, 'mozNoiseSuppression', 'noiseSuppression'), e
                );
              };
            }
                  ...
                  c = (function (t, o) {
                    ...
                    return (
                      i.length > 0
                        ...
                        : 'firefox' === n.browser && -1 !== o && (r = 2147483637),
                      r
                    );
                  })(arguments[0], i);
                r =
                  0 === a && 0 === c ? Number.POSITIVE_INFINITY : 0 === a || 0 === c ? Math.max(a, c) : Math.min(a, c);
                var s = {};
          ...
          switch (h.browser) {
            case 'chrome':
              if (!i || !i.shimPeerConnection || !m.shimChrome)
                return o('Chrome shim is not included in this adapter release.'), d;
            ...
            case 'firefox':
              if (!s || !s.shimPeerConnection || !m.shimFirefox)
                return o('Firefox shim is not included in this adapter release.'), d;
            ...
            case 'edge':
              if (!r || !r.shimPeerConnection || !m.shimEdge)
                return o('MS edge shim is not included in this adapter release.'), d;
          ...
          n = (function (t) {
            ...
            return (
              ...
              (r.prototype.doNextTask = function () {
                0 !== this.size &&
                  (this.processing || ((this._processing = !0), this.fileReader.readAsArrayBuffer(this.queue.shift())));
              }),
              r
            );
          })(r.EventEmitter);
              ...
              (i.prototype._createServerConnection = function () {
                ...
                return (
                  ...
                  t.on(d.SocketEventType.Disconnected, function () {
                    e.disconnected ||
                      (e.emitError(d.PeerErrorType.Network, 'Lost connection to server.'), e.disconnect());
                  }),
